    ...
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Logins != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Logins'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Senha")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Senha")] Login login)
        {
            if (id != login.Id)
            {
                return NotFound();
